...
func TestEncodeBodyGolden(t *testing.T) {
	tests := []struct {
		...
		{"MMEConfigurationUpdate", (&MMEConfigurationUpdate{RelativeMMECapacity: new(uint8)}).encodeBody, "0000010057000100"},
		{"MMEConfigurationUpdateAcknowledge", (&MMEConfigurationUpdateAcknowledge{}).encodeBody, "000000"},
		{"MMEConfigurationUpdateFailure", (&MMEConfigurationUpdateFailure{Cause: new(Cause)}).encodeBody, "000001000240020000"},

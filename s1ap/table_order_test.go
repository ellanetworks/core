...
func TestTableOrderMatchesASN1(t *testing.T) {
	tests := []struct {
		...
		{"ErrorIndication", tableIDs(errorIndicationIEs), []ProtocolIEID{idMMEUES1APID, idENBUES1APID, idCause, idCriticalityDiagnostics}},
		...
		{"S1SetupResponse", tableIDs(s1SetupResponseIEs), []ProtocolIEID{idMMEname, idServedGUMMEIs, idRelativeMMECapacity, idCriticalityDiagnostics}},

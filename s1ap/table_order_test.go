...
func TestTableOrderMatchesASN1(t *testing.T) {
	tests := []struct {
		...
		{"HandoverRequest", tableIDs(handoverRequestIEs), []ProtocolIEID{idMMEUES1APID, idHandoverType, idCause, idUEAggregateMaximumBitrate, idERABToBeSetupListHOReq, idSourceToTargetTransparentContainer, idUESecurityCapabilities, idSecurityContext, idNASSecurityParameterstoEUTRAN}},

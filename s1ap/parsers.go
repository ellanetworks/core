...
var messageParsers = []messageParser{
	...
	{"ParseMMEConfigurationUpdate", func(v []byte) error { _, err := ParseMMEConfigurationUpdate(v); return err }},
	{"ParseMMEConfigurationUpdateAcknowledge", func(v []byte) error { _, err := ParseMMEConfigurationUpdateAcknowledge(v); return err }},
	{"ParseMMEConfigurationUpdateFailure", func(v []byte) error { _, err := ParseMMEConfigurationUpdateFailure(v); return err }},
	...
	{"ParseUEContextModificationFailure", func(v []byte) error { _, err := ParseUEContextModificationFailure(v); return err }},
	{"ParseUEContextModificationRequest", func(v []byte) error { _, err := ParseUEContextModificationRequest(v); return err }},
	{"ParseUEContextModificationResponse", func(v []byte) error { _, err := ParseUEContextModificationResponse(v); return err }},

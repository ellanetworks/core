...
func TestGetRoute_Success(t *testing.T) {
	...
	getSubOpts := &client.GetRouteOptions{
		ID: id,
	}
	route, err := clientObj.GetRoute(getSubOpts)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func TestGetRoute_Failure(t *testing.T) {
	...
	_, err := clientObj.GetRoute(getSubOpts)
	if err == nil {
		t.Fatalf("expected error, got none")
	}
}
...
func TestDeleteRoute_Success(t *testing.T) {
	...
	deleteSubOpts := &client.DeleteRouteOptions{
		ID: id,
	}
	err := clientObj.DeleteRoute(deleteSubOpts)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
}

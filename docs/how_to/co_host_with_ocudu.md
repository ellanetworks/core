...
Disabling GRO on the N6 interface is required for IPv6 GTP-U transport in `tcx` mode — see [Segmentation offload on TCX](../explanation/user_plane_packet_processing_with_ebpf.md#segmentation-offload-on-tcx).

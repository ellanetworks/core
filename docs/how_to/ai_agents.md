...
2. **A user for your AI agent with an API token**. Create a user for your agent in the UI with a role that matches the permissions you want to grant. Then generate an API token for that user and copy it.

...
| app_xdp_nat_drop_total | Packets dropped by the NAT engine, with label for reason (fragment, port_exhausted, unsupported_proto, malformed, icmp_untranslatable). | Counter |

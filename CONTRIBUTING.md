...
```shell
rockcraft pack
sudo rockcraft.skopeo --insecure-policy copy oci-archive:ella-core_v0.0.7_amd64.rock docker-daemon:ella-core:latest
...
rockcraft pack -v
sudo rockcraft.skopeo --insecure-policy copy oci-archive:ella-core_0.0.7_amd64.rock docker-daemon:ella-core:latest

...
// Apply enciphers or deciphers data under 128-EEA1/128-NEA1, which are the same
// operation (TS 33.401 Annex B.1, TS 33.501 Annex D.2.1).
func (snow3gCipher) Apply(key CipherKey, count uint32, bearer Bearer, direction Direction, data []byte) ([]byte, error) {
...
// MAC computes the 128-EIA1/128-NIA1 NAS-MAC over msg (TS 33.401 Annex B.2,
// TS 33.501 Annex D.3.1).
func (snow3gIntegrity) MAC(key IntegrityKey, count uint32, bearer Bearer, direction Direction, msg []byte) ([4]byte, error) {
...
func (snow3gIntegrity) isIntegrity() {}

func (snow3gCipher) isCipher() {}

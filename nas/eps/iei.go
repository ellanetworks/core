...
// same IEI wherever they appear, so each is defined once here rather than per
// message file.
const (
	// gutiIEI is the GUTI IE (TS 24.301 §9.9.3.12), assigned to the UE in ATTACH
	// ACCEPT and TRACKING AREA UPDATE ACCEPT.
	gutiIEI = 0x50
	// emmCauseIEI is the EMM cause IE (TS 24.301 §9.9.3.9), carried in ATTACH
	...
	// §9.9.3.12A), carried in ATTACH ACCEPT and TRACKING AREA UPDATE ACCEPT.

...
func TestTAIListRoundTrip(t *testing.T) {
	cases := map[string]TAIList{
		...
		"several partial lists": {
			...
			{Type: PartialTAIListPerPLMN, TAIs: []TAI{{PLMN: nas.PLMN{MCC: "999", MNC: "70"}, TAC: 0xABCDEF}}},
		},
	}
...
func TestTAIListRejectsInconsistentPartialList(t *testing.T) {
	cases := map[string]TAIList{
		...
		"TAC beyond 24 bits": {
			{Type: PartialTAIListNonConsecutive, TAIs: []TAI{{PLMN: nas.PLMN{MCC: "001", MNC: "01"}, TAC: 0x0100_0000}}},
		},
	}

...
const PROTOCOL_NAMES: Record<number, string> = {
  ...
  12: "PUP", 13: "ARGUS", 14: "EMCON", 15: "XNET", 16: "CHAOS", 17: "UDP",
  ...
  55: "Min-IPv4", 56: "TLSP", 57: "SKIP", 58: "IPv6-ICMP", 59: "IPv6-NoNxt",
  ...
  94: "IPIP", 95: "MICP", 96: "SCC-SP", 97: "ETHERIP", 98: "ENCAP",
  ...
  115: "L2TP", 116: "DDX", 117: "IATP", 118: "STP", 119: "SRP", 120: "UTI",
  121: "SMP", 122: "SM", 123: "PTP", 124: "ISIS", 125: "FIRE", 126: "CRTP",
...
const Traffic: React.FC = () => {
  ...
  const currentTab = TAB_PATHS.includes(location.pathname as typeof TAB_PATHS[number])
  ...
  const {
    ...
    queryFn: () =>
      getUsage(accessToken || "", startDate, endDate, selectedSubscriber, "subscriber"),
  ...
  const {
    ...
    queryFn: () =>
      getUsage(accessToken || "", startDate, endDate, selectedSubscriber, "day"),
    enabled: !!accessToken && !!startDate && !!endDate,
    placeholderData: (prev) => prev,
  });
  ...
  const activeFlowFilters = useMemo(() => {
    ...
    return f;
  }, [startDate, endDate, selectedSubscriber, appliedProtocol, appliedSourceIp, appliedDestinationIp]);
  ...
  const flowColumns: GridColDef<FlowReport>[] = useMemo(
    () => [
      { field: "subscriber_id", headerName: "Subscriber", flex: 1, minWidth: 160 },
      ...
      { field: "destination_ip", headerName: "Destination IP", flex: 1, minWidth: 140 },
      {
  ...
  const handleConfirmClearUsage = async () => {
    ...
    try {
      ...
      setAlert({ message: "All usage data cleared successfully!", severity: "success" });
    } catch (error: unknown) {
      setAlert({
  ...
  const handleConfirmClearFlows = async () => {
    ...
    try {
      ...
      setAlert({ message: "All flow report data cleared successfully!", severity: "success" });
    } catch (error: unknown) {
      setAlert({
    ...
    >
      ...
      <EditUsageRetentionPolicyModal
        ...
        onSuccess={() => {
          ...
          setAlert({ message: "Usage retention policy updated!", severity: "success" });
        }}
      ...
      <EditFlowReportsRetentionPolicyModal
        ...
        onSuccess={() => {
          ...
          setAlert({ message: "Flow reports retention policy updated!", severity: "success" });
        }}

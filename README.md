...
You need a [Production License](https://ellanetworks.com/pricing) to run Ella Core in production. For more information, view our [License FAQ](https://ellanetworks.com/license-faq).

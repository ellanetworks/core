...
func init() {
	scenarios.Register(scenarios.Scenario{
		Name:      "enb/deregistration",
		BindFlags: func(fs *pflag.FlagSet) any { return struct{}{} },
		Run: func(ctx context.Context, env scenarios.Env, params any) error {
			return runEnbDeregistration(ctx, env, params)
		},
		Fixture: fixtureEnbDeregistration,
	})
}
...
func runEnbDeregistration(_ context.Context, env scenarios.Env, _ any) error {
	g := env.FirstGNB()
	...
	err = newUE.SendDeregistrationRequest(ngeNB.GetAMFUENGAPID(int64(scenarios.DefaultRANUENGAPID)), int64(scenarios.DefaultRANUENGAPID))
	if err != nil {

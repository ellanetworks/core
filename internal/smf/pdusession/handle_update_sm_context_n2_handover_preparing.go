...
func UpdateSmContextN2HandoverPreparing(smContextRef string, n2Data []byte) ([]byte, error) {
	...
	n2Rsp, err := context.BuildPDUSessionResourceSetupRequestTransfer(smContext.PolicyData.SessionRule, smContext.PolicyData.QosData, smContext.Tunnel.DataPath.DPNode.UpLinkTunnel.TEID, smContext.Tunnel.DataPath.DPNode.UpLinkTunnel.N3IP)
	if err != nil {

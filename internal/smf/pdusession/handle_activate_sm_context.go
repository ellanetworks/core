...
func ActivateSmContext(smContextRef string) ([]byte, error) {
	...
	n2Buf, err := context.BuildPDUSessionResourceSetupRequestTransfer(smContext.PolicyData.SessionRule, smContext.PolicyData.QosData, smContext.Tunnel.DataPath.DPNode)
	if err != nil {

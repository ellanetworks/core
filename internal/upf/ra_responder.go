...
func (r *RAResponder) Start() error {
	...
	// The hook has to match the loaded object: TCX for the SCHED_CLS build,
	// generic XDP for the XDP build. Native veth XDP redirect would require
	// an XDP_PASS stub on the peer.

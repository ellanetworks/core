...
type N3N6EntrypointFragKey4 struct {
	_     structs.HostLayout
	Saddr uint32
	Daddr uint32
	Id    uint16
...
type N3N6EntrypointFragKey6 struct {
	_     structs.HostLayout
	Id    uint32
	Pad   uint32
	Saddr N3N6EntrypointIn6Addr
...
type N3N6EntrypointFragPorts struct {
	_     structs.HostLayout
	Sport uint16
	Dport uint16
	NatId uint16
...
type N3N6EntrypointFramedIp4Key struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type N3N6EntrypointFramedIp6Key struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      N3N6EntrypointIn6Addr
}
...
type N3N6EntrypointQerKey struct {
	_     structs.HostLayout
	Seid  uint64
	QerId uint32
	Pad   uint32
...
type N3N6EntrypointQerWindow struct {
	_       structs.HostLayout
	UlStart uint64
	DlStart uint64
}
...
const (
	...
	N3N6EntrypointVarN3RoutingIfindex    = "n3_routing_ifindex"
	N3N6EntrypointVarN3Vlan              = "n3_vlan"
	N3N6EntrypointVarN6Ifindex           = "n6_ifindex"
	N3N6EntrypointVarN6RoutingIfindex    = "n6_routing_ifindex"

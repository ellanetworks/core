...
static __always_inline __u32 handle_echo_request(struct n6_packet_context *ctx)
{
...
static __always_inline long remove_gtp_header(struct n6_packet_context *ctx)
{
    if (!ctx->gtp)
    {
...
static __always_inline __u32 add_gtp_over_ip4_headers(struct n6_packet_context *ctx, int saddr, int daddr, __u8 tos, __u8 qfi, int teid)
{
...
static __always_inline void update_gtp_tunnel(struct n6_packet_context *ctx, int srcip, int dstip, __u8 tos, int teid)
{

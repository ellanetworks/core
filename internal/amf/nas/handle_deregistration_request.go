...
// TS 23.502
func handleDeregistrationRequestUEOriginatingDeregistration(ctx context.Context, ue *amf.UeContext, req *fgs.DeregistrationRequestUEOriginating, integrityVerified bool) nasreply.Disposition {
	...
	// TS 23.502
	if req.AccessType != fgs.AccessType3GPP {
		return nasreply.Handled()
	}

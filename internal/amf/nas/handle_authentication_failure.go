...
func handleAuthenticationFailure(ctx context.Context, amfInstance *amf.AMF, ue *amf.UeContext, fail *fgs.AuthenticationFailure) nasreply.Disposition {
	...
	case fgs.GMMCauseMACFailure:
		...
		return nasreply.Handled()
	case fgs.GMMCauseNon5GAuthenticationUnacceptable:
		...
		return nasreply.Handled()
	case fgs.GMMCauseNgKSIAlreadyInUse:
	...
	case fgs.GMMCauseSynchFailure: // TS 24.501

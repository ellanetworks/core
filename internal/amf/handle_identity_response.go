...
func updateUEIdentity(ue *UeContext, mobileIdentityContents []uint8, integrityVerified bool) error {
	if ue == nil {
...
func handleIdentityResponse(ctx context.Context, amfInstance *AMF, ue *UeContext, msg *nasMessage.IdentityResponse, integrityVerified bool) error {
	switch ue.GetState() {
	case Authentication:

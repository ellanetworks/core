...
func handleRegistrationComplete(ctx context.Context, amfInstance *AMF, ue *UeContext) error {
	if ue.GetState() != ContextSetup {
	...
	SendConfigurationUpdateCommand(ctx, amfInstance, ue, false)

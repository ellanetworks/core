...
func HandleNAS(ctx context.Context, amfInstance *AMF, ue *RanUe, nasPdu []byte) error {
	if ue == nil {
	...
	result, err := DecodeNASMessage(ue.UeContext(), nasPdu)
	if err != nil {
	...
	case VerdictIntegrityVerified:
		integrityVerified = true
	case VerdictPlainAllowed, VerdictMacFailedAllowed:
...
*/
func fetchUeContextWithMobileIdentity(ctx context.Context, amfInstance *AMF, payload []byte) (*UeContext, error) {
	if payload == nil {

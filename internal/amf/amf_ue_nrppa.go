...
func (ue *AmfUe) SetRadioMeasurements(m *RadioMeasurements) {
	if m == nil {
		return
	}
...
func (ue *AmfUe) GetRadioMeasurements() *RadioMeasurements {
	ue.radioMu.RLock()
...
func (ue *AmfUe) SetNRPPaMessage(data []byte) {
	ue.nrppaMu.Lock()
...
func (ue *AmfUe) GetNRPPaMessages() []NRPPaMessage {
	ue.nrppaMu.RLock()

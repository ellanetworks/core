...
func TestHandleRegistrationRequest_Timers_Stopped(t *testing.T) {
	...
	ue.NasConn().T3513 = NewTimer(10*time.Minute, 10, func(e int32) {}, func() {})
	ue.NasConn().T3565 = NewTimer(10*time.Minute, 10, func(e int32) {}, func() {})
...
func buildUeAndRadio() (*UeContext, *FakeNGAPSender, error) {
	ue := NewUeContext()

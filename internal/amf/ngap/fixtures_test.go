...
func (f *fakeSmfSbi) CreateSmContext(ctx context.Context, supi etsi.SUPI, pduSessionID uint8, dnn string, snssai *models.Snssai, _ fgs.RequestType, n1Msg []byte) (string, []byte, error) {
	return "", nil, nil
}

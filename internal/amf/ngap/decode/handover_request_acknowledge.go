...
// PDU body (3GPP TS 38.413). AMFUENGAPID and RANUENGAPID are surfaced as
// pointers because 0 is a valid NGAP UE NGAP ID and absent must be
// distinguishable from present.

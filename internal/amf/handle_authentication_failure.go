...
func handleAuthenticationFailure(ctx context.Context, amfInstance *AMF, ue *UeContext, msg *nasMessage.AuthenticationFailure) error {
	...
	case nasMessage.Cause5GMMMACFailure:
		...
		err := SendAuthenticationReject(ctx, ranUe)
		if err != nil {

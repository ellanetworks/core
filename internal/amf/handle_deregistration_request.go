...
// TS 23.502 4.2.2.3
func handleDeregistrationRequestUEOriginatingDeregistration(ctx context.Context, ue *UeContext, msg *nasMessage.DeregistrationRequestUEOriginatingDeregistration, integrityVerified bool) error {
	...
	if msg.GetSwitchOff() == 0 {
		err := SendDeregistrationAccept(ctx, ranUe)
		if err != nil {

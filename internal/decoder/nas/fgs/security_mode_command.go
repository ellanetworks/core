...
type SecurityModeCommand struct {
	...
	ReplayedS1UESecurityCapabilities *nasie.UESecurityCapability `json:"replayed_s1_ue_security_capabilities,omitempty"`
...
func buildSecurityModeCommand(msg *fgs.SecurityModeCommand) *SecurityModeCommand {
	...
	if msg.ReplayedS1UESecurityCapability != nil {
		out.ReplayedS1UESecurityCapabilities = nasie.UESecurityCapabilityFromBytes(msg.ReplayedS1UESecurityCapability)
	}

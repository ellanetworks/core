...
type RegistrationRequest struct {
	...
	S1UENetworkCapability   *nasie.UENetworkCapability         `json:"s1_ue_network_capability,omitempty"`
...
func buildRegistrationRequest(msg *fgs.RegistrationRequest) *RegistrationRequest {
	out := &RegistrationRequest{
		...
		NASKeySetIdentifier:    utils.NewKeySetIdentifier(msg.NgKSI),
	...
	out.S1UENetworkCapability = nasie.UENetworkCapabilityFromBytes(msg.S1UENetworkCapability)

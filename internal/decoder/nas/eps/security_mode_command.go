...
type SecurityModeCommand struct {
	...
	ReplayedUESecurityCapability *nasie.UESecurityCapability `json:"replayed_ue_security_capability,omitempty"`
...
func buildSecurityModeCommand(msg *eps.SecurityModeCommand) *SecurityModeCommand {
	...
	out.ReplayedUESecurityCapability = nasie.UESecurityCapabilityFrom(msg.ReplayedUESecurityCapability)

...
// literally makes "0A0B0C" and "0a0b" fail against the "0a0b0c" a UE signals, so
// every comparison goes through here. A value with no canonical form is returned
// unchanged, so it still fails to match rather than matching wrongly.

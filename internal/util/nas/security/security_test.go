...
func TestConfidentialityEEA3(t *testing.T) {
	...
	testSets := []struct {
		...
		{
			name:      "EEA3TestSet1",
			key:       [16]byte{0x17, 0x3d, 0x14, 0xba, 0x50, 0x03, 0x73, 0x1d, 0x7a, 0x60, 0x04, 0x94, 0x70, 0xf0, 0x0a, 0x29},
			count:     0x66035492,
			bearer:    0x0f,
			direction: 0,
			length:    193,
			plainText: []byte{
				0x6c, 0xf6, 0x53, 0x40, 0x73, 0x55, 0x52, 0xab, 0x0c, 0x97, 0x52, 0xfa, 0x6f, 0x90, 0x25, 0xfe, 0x0b, 0xd6, 0x75,
				0xd9, 0x00, 0x58, 0x75, 0xb2, 0x00, 0x00, 0x00, 0x00,
			},
			cipherText: []byte{
				0xa6, 0xc8, 0x5f, 0xc6, 0x6a, 0xfb, 0x85, 0x33, 0xaa, 0xfc, 0x25, 0x18, 0xdf, 0xe7, 0x84, 0x94, 0x0e, 0xe1, 0xe4,
				0xb0, 0x30, 0x23, 0x8c, 0xc8, 0x00, 0x00, 0x00, 0x00,
			},
		},
		{
			name:      "EEA3TestSet2",
			key:       [16]byte{0xe5, 0xbd, 0x3e, 0xa0, 0xeb, 0x55, 0xad, 0xe8, 0x66, 0xc6, 0xac, 0x58, 0xbd, 0x54, 0x30, 0x2a},
			count:     0x56823,
			bearer:    0x18,
			direction: 1,
			length:    800,
			plainText: []byte{
				0x14, 0xa8, 0xef, 0x69, 0x3d, 0x67, 0x85, 0x07, 0xbb, 0xe7, 0x27, 0x0a, 0x7f, 0x67, 0xff, 0x50, 0x06, 0xc3, 0x52,
				0x5b, 0x98, 0x07, 0xe4, 0x67, 0xc4, 0xe5, 0x60, 0x00, 0xba, 0x33, 0x8f, 0x5d, 0x42, 0x95, 0x59, 0x03, 0x67, 0x51,
				0x82, 0x22, 0x46, 0xc8, 0x0d, 0x3b, 0x38, 0xf0, 0x7f, 0x4b, 0xe2, 0xd8, 0xff, 0x58, 0x05, 0xf5, 0x13, 0x22, 0x29,
				0xbd, 0xe9, 0x3b, 0xbb, 0xdc, 0xaf, 0x38, 0x2b, 0xf1, 0xee, 0x97, 0x2f, 0xbf, 0x99, 0x77, 0xba, 0xda, 0x89, 0x45,
				0x84, 0x7a, 0x2a, 0x6c, 0x9a, 0xd3, 0x4a, 0x66, 0x75, 0x54, 0xe0, 0x4d, 0x1f, 0x7f, 0xa2, 0xc3, 0x32, 0x41, 0xbd,
				0x8f, 0x01, 0xba, 0x22, 0x0d,
			},
			cipherText: []byte{
				0x13, 0x1d, 0x43, 0xe0, 0xde, 0xa1, 0xbe, 0x5c, 0x5a, 0x1b, 0xfd, 0x97, 0x1d, 0x85, 0x2c, 0xbf, 0x71, 0x2d, 0x7b,
				0x4f, 0x57, 0x96, 0x1f, 0xea, 0x32, 0x08, 0xaf, 0xa8, 0xbc, 0xa4, 0x33, 0xf4, 0x56, 0xad, 0x09, 0xc7, 0x41, 0x7e,
				0x58, 0xbc, 0x69, 0xcf, 0x88, 0x66, 0xd1, 0x35, 0x3f, 0x74, 0x86, 0x5e, 0x80, 0x78, 0x1d, 0x20, 0x2d, 0xfb, 0x3e,
				0xcf, 0xf7, 0xfc, 0xbc, 0x3b, 0x19, 0x0f, 0xe8, 0x2a, 0x20, 0x4e, 0xd0, 0xe3, 0x50, 0xfc, 0x0f, 0x6f, 0x26, 0x13,
				0xb2, 0xf2, 0xbc, 0xa6, 0xdf, 0x5a, 0x47, 0x3a, 0x57, 0xa4, 0xa0, 0x0d, 0x98, 0x5e, 0xba, 0xd8, 0x80, 0xd6, 0xf2,
				0x38, 0x64, 0xa0, 0x7b, 0x01,
			},
		},
		{
			name:      "EEA3TestSet3",
			key:       [16]byte{0xd4, 0x55, 0x2a, 0x8f, 0xd6, 0xe6, 0x1c, 0xc8, 0x1a, 0x20, 0x09, 0x14, 0x1a, 0x29, 0xc1, 0x0b},
			count:     0x76452ec1,
			bearer:    0x02,
			direction: 1,
			length:    1570,
			plainText: []byte{
				,
			},
			cipherText: []byte{
				,
			},
		},
		{
			name:      "EEA3TestSet4",
			key:       [16]byte{0xdb, 0x84, 0xb4, 0xfb, 0xcc, 0xda, 0x56, 0x3b, 0x66, 0x22, 0x7b, 0xfe, 0x45, 0x6f, 0x0f, 0x77},
			count:     0xe4850fe1,
			bearer:    0x10,
			direction: 1,
			length:    2798,
		...
		{
			name:      "EEA3TestSet5",
			key:       [16]byte{0xe1, 0x3f, 0xed, 0x21, 0xb4, 0x6e, 0x4e, 0x7e, 0xc3, 0x12, 0x53, 0xb2, 0xbb, 0x17, 0xb3, 0xe0},
			count:     0x2738cdaa,
			bearer:    0x1a,
			direction: 0,
			length:    4019,
	...
	for _, ts := range testSets {
		t.Run(ts.name, func(t *testing.T) {
			...
			if !bytes.Equal(ts.cipherText, cipher) {
				t.Errorf("expected %v, got %v", ts.cipherText, cipher)
			}
		})
	}
}

func TestIntegrityEIA3(t *testing.T) {
	t.Parallel()
	...
	testSets := []struct {
		...
		{
			name:      "EIA3TestSet1",
			key:       [16]byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
			count:     0x0,
			bearer:    0x0,
			direction: 0,
			length:    1,
			message:   []byte{0x00, 0x00, 0x00, 0x00},
			output:    []byte{0xc8, 0xa9, 0x59, 0x5e},
		},
		{
			name:      "EIA3TestSet2",
			key:       [16]byte{0x47, 0x05, 0x41, 0x25, 0x56, 0x1e, 0xb2, 0xdd, 0xa9, 0x40, 0x59, 0xda, 0x05, 0x09, 0x78, 0x50},
			count:     0x561eb2dd,
			bearer:    0x14,
			direction: 0,
			length:    90,
			message:   []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
			output:    []byte{0x67, 0x19, 0xa0, 0x88},
		},
		{
			name:      "EIA3TestSet3",
			key:       [16]byte{0xc9, 0xe6, 0xce, 0xc4, 0x60, 0x7c, 0x72, 0xdb, 0x00, 0x0a, 0xef, 0xa8, 0x83, 0x85, 0xab, 0x0a},
			count:     0xa94059da,
			bearer:    0x0a,
			direction: 1,
			length:    577,
			message: []byte{
				0x98, 0x3b, 0x41, 0xd4, 0x7d, 0x78, 0x0c, 0x9e, 0x1a, 0xd1, 0x1d, 0x7e, 0xb7, 0x03, 0x91, 0xb1, 0xde, 0x0b, 0x35,
				0xda, 0x2d, 0xc6, 0x2f, 0x83, 0xe7, 0xb7, 0x8d, 0x63, 0x06, 0xca, 0x0e, 0xa0, 0x7e, 0x94, 0x1b, 0x7b, 0xe9, 0x13,
				0x48, 0xf9, 0xfc, 0xb1, 0x70, 0xe2, 0x21, 0x7f, 0xec, 0xd9, 0x7f, 0x9f, 0x68, 0xad, 0xb1, 0x6e, 0x5d, 0x7d, 0x21,
				0xe5, 0x69, 0xd2, 0x80, 0xed, 0x77, 0x5c, 0xeb, 0xde, 0x3f, 0x40, 0x93, 0xc5, 0x38, 0x81, 0x00, 0x00, 0x00, 0x00,
			},
			output: []byte{0xfa, 0xe8, 0xff, 0x0b},
		},
		{
			name:      "EIA3TestSet4",
			key:       [16]byte{0xc8, 0xa4, 0x82, 0x62, 0xd0, 0xc2, 0xe2, 0xba, 0xc4, 0xb9, 0x6e, 0xf7, 0x7e, 0x80, 0xca, 0x59},
			count:     0x05097850,
			bearer:    0x10,
			direction: 1,
			length:    2079,
			...
			output: []byte{0x00, 0x4a, 0xc4, 0xd6},
		},
		{
			name:      "EIA3TestSet5",
			key:       [16]byte{0x6b, 0x8b, 0x08, 0xee, 0x79, 0xe0, 0xb5, 0x98, 0x2d, 0x6d, 0x12, 0x8e, 0xa9, 0xf2, 0x20, 0xcb},
			count:     0x561eb2dd,
			bearer:    0x1c,
			direction: 0,
			length:    5670,
			...
			output: []byte{0x0c, 0xa1, 0x27, 0x92},
		},
	}
	...
	for _, ts := range testSets {
		t.Run(ts.name, func(t *testing.T) {
			...
			if !bytes.Equal(ts.output, output) {
				t.Errorf("expected %v, got %v", ts.output, output)
			}
		})
	}
}

...
const (
	...
	InitiatingMessagePresentECIDMeasurementFailureIndication
)
...
type InitiatingMessageValue struct {
	...
	ECIDMeasurementFailureIndication  *ECIDMeasurementFailureIndication  `aper:"valueExt,referenceFieldValue:3"`
}

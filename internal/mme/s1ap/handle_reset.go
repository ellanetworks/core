...
func handleReset(ctx context.Context, m *mme.MME, radio *mme.Radio, value []byte) {
	...
	sendResetAcknowledge(ctx, m, radio.Conn, req.ResetType.Part, req.Diagnostics())
}
...
func sendResetAcknowledge(ctx context.Context, m *mme.MME, conn mme.S1APWriter, connectionList []s1ap.UEAssociatedLogicalS1ConnectionItem, diag s1ap.Diagnostics) {

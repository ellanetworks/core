...
// isTrackingAreaUpdate reports whether nas is a TRACKING AREA UPDATE REQUEST this
// MME can read the type of: plain, or integrity-protected without ciphering. A
// ciphered body cannot be peeked, so it never matches. A UE arriving from 5GS
// without N26 holds no EPS security context and so sends it plain.

...
func mustSecurityContext(t *testing.T, ia nas.IntegrityAlgorithm, ca nas.CipheringAlgorithm, kInt nas.IntegrityKey, kEnc nas.CipherKey) *nas.SecurityContext { //nolint:unparam // the algorithm pair is part of the helper's shape across packages
	t.Helper()

...
func TestPageUnknownIMSI(t *testing.T) {
	...
	if err := m.NotifyDownlinkData(context.Background(), "001010000000999", 5, models.DownlinkDataArrived); err == nil {
		t.Fatal("a Downlink Data Notification should error for an unknown IMSI")
	}
}

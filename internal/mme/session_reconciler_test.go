...
// TestMMESessionReconciler_StartStop asserts the reconciler's lifecycle is safe:
...
func TestMMESessionReconciler_StartStop(t *testing.T) {
	m := newTestMME(t)
	r := NewMMESessionReconciler(m, nil)

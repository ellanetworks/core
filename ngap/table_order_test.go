...
func TestTableOrderMatchesASN1(t *testing.T) {
	tests := []struct {
		...
		{"AMFConfigurationUpdate", tableIDs(aMFConfigurationUpdateIEs), []ProtocolIEID{IDAMFName, IDServedGUAMIList, IDRelativeAMFCapacity}},
		{"AMFConfigurationUpdateAcknowledge", tableIDs(aMFConfigurationUpdateAcknowledgeIEs), []ProtocolIEID{IDCriticalityDiagnostics}},
		{"AMFConfigurationUpdateFailure", tableIDs(aMFConfigurationUpdateFailureIEs), []ProtocolIEID{IDCause, IDTimeToWait, IDCriticalityDiagnostics}},

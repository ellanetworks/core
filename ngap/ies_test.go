...
func TestEncodeIEContainerKnownVector(t *testing.T) {
	...
	// count=1 (00 01), id=27 (00 1b), criticality ignore=01 then open-type
	// length (40 02) + content (ab cd).
	want := []byte{0x00, 0x01, 0x00, 0x1b, 0x40, 0x02, 0xab, 0xcd}
...
func TestIEContainerRoundTrip(t *testing.T) {
	in := []ieField{
		{id: 27, crit: CriticalityReject, raw: []byte{0x01, 0x02, 0x03}},
